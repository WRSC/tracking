...
#id=1
 Team.create!(name:  "testTriangular's team",
             ...
             leader_id: 2)
#id=1
 Robot.create!(name:  "sailrobot",
              category: "Sailboat",
              team_id: 1)
#id=2
 Robot.create!(name:  "microsailrobot",
              category: "MicroSailboat",
              team_id: 1)
#id=3
...
#id=1-3
 3.times do |n|
	 Attempt.create!(name: "sailrobot first attempt",
								start: "20150601000000",
								end: "20150901000000",
								robot_id: 1,
								mission_id: 1,
...
#id=4-6
  3.times do |n|
	 Attempt.create!(name: "microsailboat first attempt",
								start: "20150601000000",
								end: "20150901000000",
								robot_id: 2,
								mission_id: 1,
...
#id=7
 Attempt.create!(name: "testStationkeeping's first attempt",
							...
							tracker_id: 7)
#id=8
 Attempt.create!(name: "testStationkeeping micro's first attempt",
							start: "20150601000000",
							end: "20150901000000",
							robot_id: 4,
							mission_id: 1,
...
=begin
  5.times do |n|
 		 Attempt.create!(name: "testRace's #{n} attempt",
							start: "20150601000000",
							end: "20150901000000",
							robot_id: 3,
							mission_id: 4,
